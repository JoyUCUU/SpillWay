...
//////    baseURLStr = kBaseUrlStr_Product;
//////    //企鹅
////    baseURLStr = @"http://192.168.1.132:8080/vomoho/";
//////    捷豹
//////    baseURLStr = @"http://192.168.1.106/vomoho/";
//////    捷豹
//////    baseURLStr = @"http://192.168.1.169:8080/vomoho/";
////
////    return baseURLStr;
////}
//
...
//    ALBBOpenAccountUser *loginUser=[[ALBBOpenAccountSession sharedInstance]getUser];
//    if (!loginUser) {
//        return NO;
//    }else{
//        requestPath = [NSString stringWithFormat:@"%@_%@", loginUser.accountId, requestPath];
//    }
